...
const PRICING = {
  'gpt-4.2-mini': { input: 0.10, output: 0.40 },
...
const PROVIDERS = {
  openai: {
    ...
    defaultModel: 'gpt-4.2-mini',
    endpoint: 'https://api.openai.com/v1/chat/completions',
    supportsLogprobs: true,
    scoringModel: 'gpt-4.2-mini',
  ...
  gemini: {
    ...
    supportsLogprobs: true,
    scoringModel: 'gemini-3-flash-preview',
  },
};
...
/**
 * Score tokens using Gemini API
 * Note: Gemini's logprobs support is more limited
 */
